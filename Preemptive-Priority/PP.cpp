    ...
    while (true)
    {
        ...
        for (int i = 0; i < numberOfProcesses; i++)
        {
            if (processList[i].remainingTime > 0)
            {
                ...
                {
                    if (processList[i].priority < currentHighestPriority)
                    {
                        currentHighestPriority = processList[i].priority;
        ...
        if (processList[currentHighestPriorityIndex].remainingTime == processList[currentHighestPriorityIndex].burstTime)
        {
            processList[currentHighestPriorityIndex].responseTime = currentTime;
        }

        processList[currentHighestPriorityIndex].remainingTime--;
        currentTime++;

        if (processList[currentHighestPriorityIndex].remainingTime == 0)
        {
            processList[currentHighestPriorityIndex].completionTime = currentTime;
        }
    }
